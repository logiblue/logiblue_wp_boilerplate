<section class="header-hero sitewise">
    <div class="header-hero-greet">
        <h2>Hello you,</h2>
        <h3>My name is Konstantinos.</h3>
        <h3>I'm a frontend Developer from Greece.</h3>
        <p>I enjoy working with web. Buildiing things that works and looks is my passion.
